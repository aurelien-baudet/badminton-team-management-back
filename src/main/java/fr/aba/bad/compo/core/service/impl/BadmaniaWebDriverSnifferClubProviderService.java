...
@Service
public class BadmaniaWebDriverSnifferClubProviderService implements ClubProviderService {
	...
	@Autowired
	public BadmaniaWebDriverSnifferClubProviderService(WebDriverFactory factory) {
		super();
