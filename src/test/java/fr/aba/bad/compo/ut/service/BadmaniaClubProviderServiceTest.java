...
public class BadmaniaClubProviderServiceTest {
	BadmaniaSnifferClubProviderService badmaniaSnifferService;

	@Before
	public void setup() {
		badmaniaSnifferService = new BadmaniaSnifferClubProviderService(() -> new FirefoxDriver());
	}
	
	@Test
	public void playerClub() throws RankingException, MalformedURLException, ClubProviderException {
		Club club = badmaniaSnifferService.getClub(new InternalPlayer().badInfo(new BadInformation().licence("6753956")));
